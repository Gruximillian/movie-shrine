...
const ImageViewModal = (props) => {
  ...
  const { images, initialImageIndex, tmdbConfiguration, initModalClose } = props;
  ...
  return (
    <div
      ...
      className={`${classes.ImageViewContainer} scale-transition scale-out`}
    >
      <div className={classes.CloseImageViewButton} onClick={closeModal}>
        {icons.close}
      </div>
