  ...
  return (
    <div className={classes.LoginModalWrapper}>
      <div
        ...
        className={`${classes.LoginModal} scale-transition scale-out`}
      >
        ...
        <div>
          ...
          <p>
            After you authenticate you will be redirected back to this page and you will be able to add movies and TV
            shows to your "Favourites" and "Watch later" lists.
          </p>
          <div onClick={initLogin} className={`${classes.LoginButton} btn btn-small`}>
            Login
          </div>
