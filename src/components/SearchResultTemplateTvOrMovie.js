...
const SearchResultTemplateTvOrMovie = (props) => {
  const { tmdbConfiguration, result, loggedIn } = props;
    ...
    <div className={`${classes.SearchResult} card`}>
      ...
      <div className={`${classes.CardContent} card-content`}>
        ...
        <ul>
          ...
          <li>
            <strong className={classes.DetailsLabel}>Type:</strong> {result.media_type}
          </li>
          <li>
            <strong className={classes.DetailsLabel}>Year:</strong> {year}
          </li>
          <li>
            <strong className={classes.DetailsLabel}>Language:</strong> {language}
          </li>
          <li>
